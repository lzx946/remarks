...
alter table employee_public_credit modify `certificate` varchar(5000) DEFAULT NULL COMMENT '证书信息';
alter table employee_public_credit modify `lose_credit` varchar(5000) DEFAULT NULL COMMENT '失信人信息';
alter table merchant_public_credit modify `general_credit` varchar(5000) DEFAULT NULL COMMENT '通用信用';
alter table merchant_public_credit modify `serious_dishonesty` varchar(5000) DEFAULT NULL COMMENT '严重违法失信';
