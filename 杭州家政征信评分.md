...
CREATE TABLE `dimension` (
  ...
  `dimension_image` varchar(100) NOT NULL DEFAULT '' COMMENT '维度图片',
  `dimension_subtitle` varchar(50) NOT NULL DEFAULT '' COMMENT '维度副标题',
  `dimension_explain` varchar(200) NOT NULL DEFAULT '' COMMENT '维度说明',
