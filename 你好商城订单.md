...
ALTER TABLE pay_message ADD COLUMN `out_trade_no` varchar(20) DEFAULT '' COMMENT '第三方交易单号（微信、支付宝）';
...
```sql
CREATE TABLE `goods_order_physical` (
  `id` varchar(20) NOT NULL,
  `order_id` varchar(20) NOT NULL COMMENT '关联order_physical_goods表中order_id',
  `sku_id` varchar(20) NOT NULL COMMENT '商品规格子商品Id',
  `item_name` varchar(100) DEFAULT NULL,
  `goods_id` varchar(20) DEFAULT NULL COMMENT '商品id',
  `goods_name` varchar(100) NOT NULL,
  `subtitle` varchar(100) DEFAULT NULL COMMENT '商品服务副标题',
  `original_price` int(10) NOT NULL COMMENT '原价',
  `current_price` int(10) NOT NULL COMMENT '现价',
  `goods_pic` varchar(300) DEFAULT NULL COMMENT '图片地址',
  `store_code` varchar(20) DEFAULT NULL COMMENT '门店编号',
  `goods_num` varchar(5) NOT NULL DEFAULT '1' COMMENT '商品数量',
  `one_class_id` varchar(20) DEFAULT NULL COMMENT '商品服务一级类目id',
  `one_class_name` varchar(255) DEFAULT NULL COMMENT '商品服务一级类目名称',
  `two_class_id` varchar(20) DEFAULT NULL COMMENT '商品服务二级类目id',
  `two_class_name` varchar(255) DEFAULT NULL COMMENT '商品服务二级类目名称',
  `coupon_id` varchar(20) DEFAULT NULL COMMENT '优惠券id',
  `app_id` varchar(20) DEFAULT NULL COMMENT '优惠券来源',
  `create_date` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `modify_date` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `stock_id` varchar(20) DEFAULT NULL COMMENT '库存扣减id',
  `allow_pay_type` char(1) DEFAULT '0' COMMENT '允许使用的支付方式0-先付后服务，1-先服务后付，2-两种模式均可',
  PRIMARY KEY (`id`),
  KEY `order_id` (`order_id`),
  KEY `one_class_id` (`one_class_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='商城实物商品订单关联表';
```