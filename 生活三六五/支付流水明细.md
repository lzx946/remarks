...
-- 支付收款人信息
CREATE TABLE `payee_info` (
  `id` varchar(20) NOT NULL COMMENT 'id',
  `pay_message_id` varchar(20) NOT NULL COMMENT 'pay_message表id', -- 新加的
  `peyeeinfo` varchar(2000) DEFAULT NULL COMMENT '收款人',             -- 新加的
  `account_flow_id` varchar(20) NOT NULL COMMENT '资金流ID',
  `create_date` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `modify_date` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='支付收款人信息';
...
CREATE TABLE `refund_detail` (
  ...
  `account_flow_id` varchar(30) NOT NULL COMMENT '退款对应的资金流ID',
  `create_date` timestamp NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  `modify_date` timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间',
...
CREATE TABLE `withdrawal_detail` (
  ...
  `account_flow_ids` varchar(5000) NOT NULL COMMENT 'account_flow表的ID',
