...
CREATE TABLE `activity_member` (
  ...
  `activity_id` varchar(20) NOT NULL COMMENT '活动id',
  `member_id` varchar(20) NOT NULL COMMENT '会员id',
  `is_must` varchar(1) NOT NULL DEFAULT '1' COMMENT '逻辑删除用（置0）',
  `standard_flag` varchar(1) NOT NULL DEFAULT '0' COMMENT '是否达标0=否，1=是',
...
ALTER TABLE white_list MODIFY `create_time` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间';

ALTER TABLE white_list MODIFY `modify_time` TIMESTAMP NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '修改时间';
